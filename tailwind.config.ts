  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        subject: {
          approved: "hsl(var(--subject-approved))",
          available: "hsl(var(--subject-available))",
          blocked: "hsl(var(--subject-blocked))",
        },
        sidebar: {
      ...
      boxShadow: {
        ...
        medium: "0 4px 16px -4px hsl(var(--foreground) / 0.1), 0 2px 4px -2px hsl(var(--foreground) / 0.06)",
        large: "0 8px 32px -8px hsl(var(--foreground) / 0.15), 0 4px 8px -4px hsl(var(--foreground) / 0.08)",
